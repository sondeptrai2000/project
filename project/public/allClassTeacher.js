...
function sendData(id) {
    ...
    if (click == 1) {
        $(".inner").show();
        var _id = id
        const studentList = "<th>avatar</th><th>username</th><th>stage</th><th>Aim</th><th>email</th><th onclick='closeStudentList()'>X</th>"
...
function studentAssessmentForm(classID, studentID, name, email) {
    $("#classID").html("<p>ClassID :" + classID + "</p>");
    $("#studentID").html("<p>StudentID :" + studentID + "</p>");
